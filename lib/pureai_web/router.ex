defmodule PureAIWeb.Router do
  use PureAIWeb, :router

  import PureAIWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {PureAIWeb.Layouts, :root}
  ...
  if Application.compile_env(:pureai, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PureAIWeb.Telemetry
